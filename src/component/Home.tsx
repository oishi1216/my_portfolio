            ...
            <SlideScaleChange isIntersecting={isIntersecting}>
                <div css={common.contentWrapper}>
                    ...
                    <div css={siteNameWrapper}>
                        <div css={siteName}>
                            <h1 css={css`font-size: 3rem;`}><motion.span custom={0} initial='init' animate={controls} variants={textAnimation}>JUNJI</motion.span> <motion.span custom={1} initial='init' animate={controls} variants={textAnimation}>OISHI</motion.span></h1>
                            <h2 css={css`font-size: 2rem;`}><motion.span custom={2} initial='init' animate={controls} variants={textAnimation}>Portfolio</motion.span> <motion.span custom={3} initial='init' animate={controls} variants={textAnimation}>Sites</motion.span></h2>
                        </div>
                    </div>
                </div>
            </SlideScaleChange>
